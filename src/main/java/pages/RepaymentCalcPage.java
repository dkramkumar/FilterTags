...
public class RepaymentCalcPage extends BasePage{
	...
	public static void scrollDownToCalculateNow() throws InterruptedException {
		By byCalculateNow = findBy("(//p//a[@aria-label='Calculate now'])[2]");
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(o, 350)", "");
		Thread.sleep(2000);
	}

	public static void setLoanAmount(String text) {
